...
def si2ks(si_folder, ks_folder, geom=None, n_jobs=2, scaleproc=True):
    if scaleproc:
        try:
...
if __name__ == "__main__":
    ...
    nc, cmpath = si2ks(args.si_folder, args.ks_folder, geom=geom, scaleproc=not args.no_scaleproc)
